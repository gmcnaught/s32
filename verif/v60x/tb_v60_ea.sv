...
v60_ea dut (
    ...
    .opbytes(e_bytes), .we(e_we), .io(1'b0), .lock(1'b0), .bit_mode(1'b0), .wdata(e_wdata),
    .ea(e_ea), .bit_resid(), .rdata(e_rdata), .rn_wb(e_wb), .rn_wb_val(e_wb_val), .rn_wb_pair(), .rn_wb_hi(),
