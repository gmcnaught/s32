...
//
//  ─── Resource cost ─────────────────────────────────────────────────────────
//  Storage is 24 * 2^AW bits. AW=10 (two 512-sample banks) maps to roughly
//  three M10Ks on Cyclone V, plus control logic and no DSPs.
//
...
module crt_adjust #(
    ...
    parameter AW        = 10                 // total address width, including ping-pong bank
)
(
    input              clk,
